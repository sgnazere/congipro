...
(async () => {
  ...
  const ov = await call(E, 'POST', '/requests', { leave_type_id: T.RTT.id, start_date: '2026-11-04', end_date: '2026-11-04', reason: 'chevauchement' });
  ...
  console.log('— Rejet (RTT, 1 niveau)');
  const rtt0 = await bal(E, 'RTT');
  const r2 = (await call(E, 'POST', '/requests', { leave_type_id: T.RTT.id, start_date: '2026-11-09', end_date: '2026-11-10', reason: 'Test audit RTT' })).data;
  ...
  check('Solde RTT : jours en attente rendus', (await bal(E, 'RTT')).pending === rtt0.pending);
  ...
  const r5 = (await call(M, 'POST', '/requests', { leave_type_id: T.RTT.id, start_date: '2026-11-23', end_date: '2026-11-23', reason: 'Test audit manager' })).data;
